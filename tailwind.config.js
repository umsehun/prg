  ...
  theme: {
    extend: {
      colors: {
        ...
        game: {
          perfect: '#22c55e',    // Green for perfect hits
          great: '#3b82f6',      // Blue for great hits
          good: '#f59e0b',       // Orange for good hits
          miss: '#ef4444',       // Red for misses
          combo: '#8b5cf6',      // Purple for combo
        },
      ...
      animation: {
        ...
        'pulse-game': 'pulseGame 1s ease-in-out infinite',
        'hit-effect': 'hitEffect 0.2s ease-out',
      },
      keyframes: {
        fadeIn: {
          '0%': { opacity: '0' },

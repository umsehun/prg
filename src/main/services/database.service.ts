...
export class DatabaseService {
    ...
    static async saveChart(chartData: {
        ...
        try {
            logger.info('db', 'Saving chart to database:', { chartId: chartData.id });
            ...
            logger.info('db', 'Chart saved successfully:', { chartId: chart.id });
            return chart;

        } catch (error) {
            logger.error('db', 'Failed to save chart:', error);
            throw error;
        }
    }
    ...
    static async submitScore(scoreData: {
        ...
        try {
            logger.info('db', 'Submitting score to database:', {
            ...
            logger.info('db', 'Score submitted successfully:', { scoreId: score.id });
            return score;

        } catch (error) {
            logger.error('db', 'Failed to submit score:', error);
            throw error;
        }
    }
    ...
    static async getOrCreateUser(userData: {
        ...
        try {
            ...
            logger.error('db', 'Failed to get or create user:', error);
            throw error;
        }
    }
    ...
    static async getUserStats(userId: string) {
        try {
            ...
            logger.error('db', 'Failed to get user stats:', error);
            throw error;
        }
    }
    ...
    static async getAllCharts() {
        try {
            ...
            logger.error('db', 'Failed to get charts:', error);
            throw error;
        }
    }
    ...
    static async getChartById(chartId: string) {
        try {
            ...
            logger.error('db', 'Failed to get chart:', error);
            throw error;
        }
    }
    ...
    static async getSettings() {
        try {
            ...
            if (!settings) {
                ...
                return await prisma.settings.create({ data: defaultSettings });
            }

            return settings;

        } catch (error) {
            logger.error('db', 'Failed to get settings:', error);
            throw error;
        }
    }
     ...
     */
    static async updateSettings(settingsData: Record<string, any>) {
        try {
            ...
            logger.error('db', 'Failed to update settings:', error);
            throw error;
        }
    }
    ...
    static async disconnect() {
        try {
            ...
            logger.error('db', 'Error disconnecting from database:', error);
        }
    }
}

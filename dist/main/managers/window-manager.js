...
class WindowManager {
                    ...
                    if (platform_1.PlatformUtils.isMacOS) {
                        setTimeout(() => {
                            try {
                                ...
                                logger_1.logger.info('window', '🔄 Forced menubar visibility after window ready');
                            }
                            catch (e) {
                                logger_1.logger.warn('window', 'Could not force menubar after ready:', e);
                            }
                        }, 500);
                    }
    ...
    getWindowConfig() {
        ...
        const platformConfig = platform_1.PlatformUtils.getWindowConfig();
        const baseConfig = {
            ...platformConfig,
            width: windowWidth,
            height: windowHeight,
            ...
            webPreferences: {
                ...
                preload: (0, path_1.join)(__dirname, '../../preload/index.js'), // ✅ Fix: dist/preload/index.js
        ...
        if (platform_1.PlatformUtils.isLinux) {
            baseConfig.icon = (0, path_1.join)(__dirname, '../../../public/icon.png');
        }
        return baseConfig;
    }
    /**
